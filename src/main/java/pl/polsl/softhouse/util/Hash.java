package pl.polsl.softhouse.util;
...
public class Hash {
    ...
    /**
     * Lenght of the hashed data in characters.
     */
    public static final int HASHED_LENGTH = 64;
     ...
     * @return hex string representation of the hashed data.
     */
